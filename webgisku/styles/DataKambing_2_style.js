...
var style_DataKambing_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("KAMBING");
    var labelText = "";
    size = 0;
    ...
    if (value > 2229.000000 && value <= 18538.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 18538.000000 && value <= 34847.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 34847.000000 && value <= 51156.000000) {
            style = [ new ol.style.Style({
